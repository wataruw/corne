...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+-----------|  |-----------+--------+--------+--------+--------+--------+--------|
      KC_LCTL,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LALT,       KC_RALT,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,   MO(4),
  //|--------+--------+--------+--------+--------+--------+-----------'  `-----------+--------+--------+--------+--------+--------+--------|
      KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                               KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,   MO(1),
  //|--------+--------+--------+--------+--------+--------+-----------.  ,-----------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI,   MO(2),     KC_SPC,        KC_ENT,  KC_ESC,  KC_DEL
                                      //`-----------------------------'  `-----------------------------'
  ...
  //|--------+--------+--------+--------+--------+--------+-----------'  `-----------+--------+--------------+------------+--------+--------+--------|
      KC_LSFT, KC_PDOT,    JP_0,    JP_1,    JP_2,    JP_3,                             KC_END,       KC_BTN1,     KC_BTN2, KC_PGDN, XXXXXXX, _______,
  //|--------+--------+--------+--------+--------+--------+-----------.  ,-----------+--------+--------------+------------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------+-----------|  |-----------+--------+--------+--------+--------+--------+--------|
      KC_LCTL,    NG_A,    NG_S,    NG_D,    NG_F,    NG_G,    KC_LEFT,       KC_RGHT,    NG_H,    NG_J,    NG_K,    NG_L, NG_SCLN, _______,
  //|--------+--------+--------+--------+--------+--------+-----------'  `-----------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------+-----------|  |-----------+-----------+--------------+------------+------------+--------+--------|
      KC_LCTL, XXXXXXX,  KC_F11,   KC_F4,   KC_F5,   KC_F6,    KC_LALT,       KC_RALT, KC_MS_LEFT,    KC_MS_DOWN,    KC_MS_UP, KC_MS_RIGHT, XXXXXXX, _______,
  //|--------+--------+--------+--------+--------+--------+-----------'  `-----------+-----------+--------------+------------+------------+--------+--------|
      KC_LSFT, XXXXXXX,  KC_F10,   KC_F1,   KC_F2,   KC_F3,                                KC_END,       KC_BTN1,     KC_BTN2,     KC_PGDN, XXXXXXX, _______,
  //|--------+--------+--------+--------+--------+--------+-----------.  ,-----------+-----------+--------------+------------+------------+--------+--------|
                                          KC_LGUI, _______,     KC_SPC,        KC_ENT, _______, _______
                                      //`-----------------------------'  `-----------------------------'
  )
